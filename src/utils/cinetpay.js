...
async function initierPaiement({ merchant_transaction_id, amount, currency, designation, client_email, client_first_name, client_last_name, client_phone_number, payment_method, success_url, failed_url, notify_url }) {
